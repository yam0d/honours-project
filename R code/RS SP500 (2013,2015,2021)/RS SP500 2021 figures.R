...
01/1871-12/2021 from Robert Shiller data", 
...
legend("topleft", legend = c("log SP500(1871-2021)", 
...
plot(dis_10, main = "SP500 distortion from 01/1871-12/2021 from 
     Robert Shiller data", 
...
plot(density(dis_10), lwd = 2, yaxs = "i",xlab ="Distortion",
     main = "SP500 distortion from 01/1871-12/2021 from 
